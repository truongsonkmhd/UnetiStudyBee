...
public class JudgeController {
    ...
    private final CodingExerciseServiceImpl codingExerciseTemplateService;
    ...
    public  ResponseEntity<IResponseMessage>  handleSubmitCode(
        ...
        CodingExercise codingExercise = codingExerciseTemplateService.getExerciseEntityByID(request.getExerciseId());
        ...
        if (attemptInfo == null) {
            ...
            attemptInfo.setLessonID(codingExerciseTemplateService.getLessonIDByExerciseID(request.getExerciseId()));
        }
    ...
    public ResponseEntity<IResponseMessage> handleSubmitCodeMQ(@RequestBody JudgeRequestDTO request) {
        try {
            ...
            CodingExercise exercise = codingExerciseTemplateService.getExerciseEntityByID(request.getExerciseId());
            if (exercise == null) {
