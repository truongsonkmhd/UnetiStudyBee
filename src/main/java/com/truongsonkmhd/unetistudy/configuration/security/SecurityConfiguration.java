                ...
                .authorizeHttpRequests(
                        authz ->
                                authz
                                        ...
                                        .requestMatchers(mvc.pattern("/api/admin/coding-exercise-template/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN ,  AuthoritiesConstants.SYS_ADMIN, AuthoritiesConstants.TEACHER)
                                        .requestMatchers(mvc.pattern("/api/admin/contest-lesson/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN ,  AuthoritiesConstants.SYS_ADMIN, AuthoritiesConstants.TEACHER)
                                        .requestMatchers(mvc.pattern("/api/admin/quiz/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN ,  AuthoritiesConstants.SYS_ADMIN, AuthoritiesConstants.TEACHER)
                                        ...
                                        .requestMatchers(mvc.pattern("/api/enrollments/**")).hasAnyAuthority(AuthoritiesConstants.ADMIN ,  AuthoritiesConstants.SYS_ADMIN  , AuthoritiesConstants.TEACHER ,AuthoritiesConstants.STUDENT)
